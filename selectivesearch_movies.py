...
def selectivesearch_movie():
    while True:
        print("PRESS 1 to search a particular movie by its title")
        print("PRESS 2 to obtain the movie according to start year")
        ...
        print("PRESS 6 to obtain the movie by its genre")
        ...
        if(choice==1):
            ...
            print("PRESS 1 to obtain all movie according to one particular start year")
            ...
            print("PRESS 1to obtain all the movie based ona particular rating")
            print("PRESS 2to obtain all the movie between 2 ratings of your choice")
            print("PRESS 3to obtain all the movie which is greater than a rating of your choice")
            print("PRESS 4to obtain all the movie which is less than a rating of your choice")
